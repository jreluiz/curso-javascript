...
```
bloco-3-navegador-dom/aula-12-projeto-lista-tarefas/
├── README.md                                       # a aula escrita
└── apresentacao/
    ├── apresentacao-12-projeto-lista-tarefas.md    # a fonte   ← edite este
    ├── apresentacao-12-projeto-lista-tarefas.pdf   # o gerado  ← projete este
    └── img/
        ├── estado-e-tela.mmd                       # diagrama para projeção
        └── estado-e-tela.svg                       # gerado do .mmd
```
...
bash recursos/slides/gerar.sh aula-12   # só uma aula
...
python3 recursos/slides/conferir.py aula-12  # só um
```
